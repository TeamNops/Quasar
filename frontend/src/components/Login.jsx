          ...
          >
            ...
            <div>
              ...
              <input
                type="email"
                id="email"
                className={`w-full px-4 py-2.5 bg-gray-700/50 border ${errors.email ? 'border-red-500' : 'border-gray-600'} text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent`}
            ...
            <div>
              ...
              <input
                type="password"
                id="password"
                className={`w-full px-4 py-2.5 bg-gray-700/50 border ${errors.password ? 'border-red-500' : 'border-gray-600'} text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent`}
                placeholder="••••••••"
                {...register("password", { 
